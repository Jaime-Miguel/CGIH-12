...
//variable para nueva variable de fuente de luz
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.3f, 0.5f, 0.7f);
        ...
        glUniform3f(lightPosLoc2, lightPos2.x + movelight2Pos, lightPos2.y + movelight2Pos, lightPos2.z + movelight2Pos);
