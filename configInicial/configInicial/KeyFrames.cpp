...
typedef struct _frame {
	...
	float incY;
	float incZ;
	//variables para rotar e incrementos
	//head
	float head;
	float headInc;
	//tail
...
void interpolation(void)
{
	...
	// Incrementos nuevos para la rotacion
	//Head
...
void DoMovement()
{
	...
	// Aumentos  y decrementos para las rotaciones faltantes
	//Head
	if (keys[GLFW_KEY_4])
	{
		head += 0.5f;
...
void Animation() {
	...
	if (play)
	{
		...
		else
		{
			...
			// Incrementos nuevos para Frame actual
			// Head
